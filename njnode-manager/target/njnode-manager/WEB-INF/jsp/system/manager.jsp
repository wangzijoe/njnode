...
<link rel="stylesheet" type="text/css" href="${rootPath}H-ui/static/h-ui.admin/css/H-ui.admin.css" />
<link rel="stylesheet" type="text/css" href="${rootPath}H-ui/lib/Hui-iconfont/1.0.8/iconfont.css" />
<link rel="stylesheet" type="text/css" href="${rootPath}H-ui/static/h-ui.admin/skin/default/skin.css" id="skin" />
...
<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="${rootPath}">超级管理</a>
			...
			<ul class="cl">
				...
				<li class="dropDown dropDown_hover">
					...
					<ul class="dropDown-menu menu radius box-shadow">
						...
						<li><a href="#">切换账户</a></li>
						<li><a href="${rootPath}logout">退出</a></li>
					</ul>
				</li>
...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		<dl id="menu-admin">
			...
			<dd>
				<ul>
					<li><a data-href="${rootPath}page/manager_perm_resourceList/toPage" data-title="资源列表" href="javascript:void(0)">资源列表</a></li>
...
<section class="Hui-article-box">
	...
	<div id="iframe_box" class="Hui-article">
		<div class="show_iframe">
			...
			<iframe scrolling="yes" frameborder="0" src="${rootPath}page/manager_welcome/toPage"></iframe>
	</div>
</div>
</section>
...
<script type="text/javascript" src="${rootPath}H-ui/static/h-ui.admin/js/H-ui.admin.js"></script> <!--/_footer 作为公共模版分离出去-->
<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="${rootPath}H-ui/lib/jquery.contextmenu/jquery.contextmenu.r2.js"></script>
