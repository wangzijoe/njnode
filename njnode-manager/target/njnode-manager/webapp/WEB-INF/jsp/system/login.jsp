...
<link rel="stylesheet" type="text/css" href="http://192.168.1.157/H-ui/static/h-ui.admin/css/H-ui.login.css" />
			...
			<form class="form form-horizontal" action="" method="post">
				...
				<div class="row cl">
					<div class="formControls col-xs-8 col-xs-offset-3">
						...
						<img onclick="refreshCode(this)" id="captcha" src="http://192.168.1.157/getCaptcha">
					</div>
				</div>
				<div class="row cl">
					<div class="formControls col-xs-8 col-xs-offset-3">
...
<script type="text/javascript" src="http://192.168.1.157/H-ui/lib/jquery.validation/1.14.0/jquery.validate.js"></script> 
<script type="text/javascript" src="http://192.168.1.157/H-ui/lib/jquery.validation/1.14.0/validate-methods.js"></script> 
<script type="text/javascript" src="http://192.168.1.157/H-ui/lib/jquery.validation/1.14.0/messages_zh.js"></script>
...
// 	    	console.log(username+"  ===  "+password+"  ===  "+tel);
	    	...
	    	NJ_NODE.ajaxPost(d,"text","http://192.168.1.157/sys/_/register",function(data){
	    		if(data){
	    			console.log(data)
...
function refreshCode(obj){
	obj.src = "http://192.168.1.157/getCaptcha?random="+Math.random();;
}
</script>
</body>
</html>