...
<aside class="Hui-aside">
    <div class="menu_dropdown bk_2">
        <dl id="menu-admin">
            ...
            <dd>
                <ul>
                    <li><a data-href="http://192.168.1.157/page/manager_perm_resourceList/toPage" data-title="资源列表"
                           href="javascript:void(0)">资源列表</a></li>
...
<script type="text/javascript" src="http://192.168.1.157/H-ui/static/h-ui.admin/js/H-ui.admin.js"></script>
<!--/_footer 作为公共模版分离出去-->
<!--请在下方写此页面业务相关的脚本-->
