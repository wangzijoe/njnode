...
<body>
	...
	<div id="myCarousel" class="carousel slide">
	    ...
	    <div class="carousel-inner">
	        <div class="item active">
	            <img src="http://192.168.1.157/H-ui/static/h-ui/images/home/15160158279.jpg" alt="First slide">
	        </div>
	        <div class="item">
	            <img src="http://192.168.1.157/H-ui/static/h-ui/images/home/15160158279.jpg" alt="Second slide">
	        </div>
	        <div class="item">
	            <img src="http://192.168.1.157/H-ui/static/h-ui/images/home/15160158279.jpg" alt="Third slide">
	        </div>
	    </div>
	    <!-- 轮播（Carousel）导航 -->
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-sm-3">
				<img alt="网络异常" src="http://192.168.1.157/H-ui/static/h-ui/images/home/home_linghuo.png">
				<h3>灵活</h3>
				<p>像积木一样，</p>
				<p>可以拼出您的定制程序</p>
			</div>
			<div class="col-sm-3">
				<img alt="网络异常" src="http://192.168.1.157/H-ui/static/h-ui/images/home/home_jiandan.png">
				<h3>简单</h3>
				<p>简单方便，</p>
				<p>响应速度更快</p>
			</div>
			<div class="col-sm-3">
				<img alt="网络异常" src="http://192.168.1.157/H-ui/static/h-ui/images/home/home_zhuanye.png">
				<h3>专业</h3>
				<p>功能强大，</p>
				<p>插件式集成小程序系统</p>
			</div>
			<div class="col-sm-3">
				<img alt="网络异常" src="http://192.168.1.157/H-ui/static/h-ui/images/home/home_shuju.png">
				<h3>数据</h3>
				<p>全面的用户数据</p>
				<p>方便运营分析和管理</p>
			</div>
